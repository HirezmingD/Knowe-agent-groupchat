...
| **API Key** | The access credential for a model provider: encrypted at rest with Windows DPAPI, never written to browser storage, and clearable in Settings | [API Key security: encrypted local storage](30-01-Models-and-Providers.md#api-key-security-not-written-to-disk) |
